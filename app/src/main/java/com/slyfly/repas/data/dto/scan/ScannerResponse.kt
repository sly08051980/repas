package com.slyfly.repas.data.dto.scan

import com.google.gson.annotations.SerializedName

data class ScanResponseProduct(
    ...
    val nutriments: ScanResponseNutriments?,
...
data class ScanResponseNutriments(
...
data class ScanResponse(
    val code: String?,
    val status: Int?,
    val product: ScanResponseProduct?,
)